...
if __name__ == "__main__":
    ...
    data_to_load = [
        ...
        (1000, 2000),
        (-5, -50),
        # Example of a value that might be too large for a 4-byte signed int
        # (2**31, 10) # This would cause a struct.error if uncommented
    ]

    # Specify the output binary file name
    output_filename = "my_exact_load_file.bin"
